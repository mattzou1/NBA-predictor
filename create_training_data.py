...
with open('nba_averages.json', 'r') as f:
...
for season_data in data:
    for game_data in season_data:
        ...
        data_point = {'team': team, 'opponent': opponent, **team_averages, **opponent_averages, 'home_game': home_game, 'WL': winlose, 'point_dif': point_dif}

        # Add the data point to the training data
        training_data.append(data_point)

# Write the training data to a new JSON file
with open('nba_training_data.json', 'w') as f:
